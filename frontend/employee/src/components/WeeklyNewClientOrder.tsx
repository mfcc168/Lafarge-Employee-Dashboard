                    ...
                    <div className="space-y-3 text-sm">
                      {e.orders && (
                        <div className="space-y-1">
                          ...
                          <p className="text-slate-700 text-sm leading-relaxed">{e.orders}</p>
                        </div>
                      )}
                      {e.tel_orders && (
                        <div className="space-y-1">
                          ...
                          <p className="text-slate-700 text-sm leading-relaxed">{e.tel_orders}</p>
                        </div>
                      )}
                      {e.samples && (
                        <div className="space-y-1">
                          ...
                          <p className="text-slate-700 text-sm leading-relaxed">{e.samples}</p>
                        </div>
                      )}
                    </div>
                  )}
