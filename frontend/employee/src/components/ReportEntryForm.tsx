  ...
  return (
    <div className="space-y-6" ref={entriesRef}>
      ...
      <div className="flex justify-center items-center gap-6 mt-8 mb-4">
        ...
        <div className="text-gray-700 font-medium select-none min-w-[120px] text-center">
      ...
      {isLoadingEntries ? (
        <div className="space-y-4">
          {[...Array(3)].map((_, i) => (
            <div key={`skeleton-${i}`} className="animate-pulse bg-gray-200 rounded-lg h-32"></div>
          ))}
        </div>
      ) : entries.length === 0 ? (
                    ...
                    <tr>
                      <td className="px-1 py-3 font-medium text-sm text-gray-700" colSpan={3}>
                        <select
                          ...
                          className="w-36 px-2 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 bg-white"
                          onFocus={() => handleFocus(index)}
                        >
      ...
      <div>
        <button
          ...
          className="group relative inline-flex items-center justify-center p-3 bg-gradient-to-br from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-gray-50 disabled:opacity-50"
        >
          <Plus 
            size={18} 
      ...
      <div className="flex flex-wrap gap-4 mt-4">
        <button
          ...
          disabled={submitting || isLoadingEntries}
